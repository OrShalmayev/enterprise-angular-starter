import { BehaviorSubject, Observable, OperatorFunction, queueScheduler, SchedulerLike } from 'rxjs';
...
import { Destroyable } from '../destroyable/destroyable-component.directive';
